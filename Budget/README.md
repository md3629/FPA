...
## Budget: Bottom-up
The scenario is a bottom-down forecasting scenario. The source data contains a planning of sales for different scenarios at a high granularity. High granularity means that the information provided is at at various level of detail: month, country, and product category, or stores.<br>
